...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<span${ssrRenderAttrs(mergeProps({ class: "handwave" }, _attrs))} data-v-b78a1c35>\u{1F44B}</span>`);
}
...
const HandWave = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b78a1c35"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VContainer, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section data-v-3412ef6c${_scopeId}>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCardTitle, { class: "text-center font-weight-bold d-flex justify-center align-center flex-wrap" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span class="d-inline-flex align-center" data-v-3412ef6c${_scopeId5}>`);
                                    _push6(ssrRenderComponent(HandWave, { style: { "font-size": "1.5rem", "margin-right": "0.5rem" } }, null, _parent6, _scopeId5));
                                    _push6(`<h1 class="hero-heading" data-v-3412ef6c${_scopeId5}>Vitaj na mm-smart.eu</h1></span>`);
                                  } else {
                                    return [
                                      createVNode("span", { class: "d-inline-flex align-center" }, [
                                        createVNode(HandWave, { style: { "font-size": "1.5rem", "margin-right": "0.5rem" } }),
                                        createVNode("h1", { class: "hero-heading" }, "Vitaj na mm-smart.eu")
                                      ])
                                    ];
                                  }
                                }),
                              ...
                              _push5(ssrRenderComponent(VCardText, { class: "text-body-1 text-center mt-8" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="text-justify" style="${ssrRenderStyle({ "line-height": "1.8" })}" data-v-3412ef6c${_scopeId5}> Tento projekt vznikol ako reakcia na pracovn\xFA ponuku pre Vue/Nuxt frontend v\xFDvoj\xE1ra. Namiesto tradi\u010Dn\xE9ho \u017Eivotopisu som sa rozhodol uk\xE1za\u0165 re\xE1lne rie\u0161enie \u2013 <strong data-v-3412ef6c${_scopeId5}>nasaden\xFA aplik\xE1ciu</strong>, ktor\xE1 be\u017E\xED na mojom vlastnom serveri (Debian + PM2 + Nginx + Git cron deploy), presne tak, ako by fungovala \u017Eiv\xE1 firemn\xE1 prezent\xE1cia. <br data-v-3412ef6c${_scopeId5}><br data-v-3412ef6c${_scopeId5}> M\xE1m predch\xE1dzaj\xFAcu prax ako frontend v\xFDvoj\xE1r v spolo\u010Dnosti <strong data-v-3412ef6c${_scopeId5}>Railsformers (2022)</strong>, kde som jeden rok vytv\xE1ral \u0161abl\xF3ny v HTML/PHP pre firemn\xE9 CMS. Pracoval som <strong data-v-3412ef6c${_scopeId5}>desktop-first</strong>, pou\u017E\xEDval <strong data-v-3412ef6c${_scopeId5}>Bootstrap</strong>, rie\u0161il z\xE1klady <strong data-v-3412ef6c${_scopeId5}>technick\xE9ho SEO</strong>, jednoduch\xE9 anim\xE1cie a z\xE1kladn\xFD <strong data-v-3412ef6c${_scopeId5}>deploy</strong>. Dnes sa akt\xEDvne pos\xFAvam k pln\xE9mu <strong data-v-3412ef6c${_scopeId5}>fullstack v\xFDvoju</strong>, zameran\xE9mu na <strong data-v-3412ef6c${_scopeId5}>modern\xFD Vue/Nuxt ekosyst\xE9m</strong>, kde pracujem s komponentov\xFDm pr\xEDstupom, TypeScriptom a DevOps n\xE1strojmi. <br data-v-3412ef6c${_scopeId5}><br data-v-3412ef6c${_scopeId5}> Popri webov\xFDch projektoch rozv\xEDjam aj vlastn\xE9 technick\xE9 experimenty, napr. <strong data-v-3412ef6c${_scopeId5}>ESP32-Smarwi Controller</strong> \u2013 syst\xE9m pre inteligentn\xE9 vetranie zalo\u017Een\xFD na DHT senzore, OTA aktualiz\xE1ci\xE1ch, HTTP API a backendom v AdonisJS. Kv\xF4li v\xE4\u010D\u0161ej \u0161k\xE1lovate\u013Enosti som pre\u0161iel z Arduino IDE na <strong data-v-3412ef6c${_scopeId5}>PlatformIO</strong> v prostred\xED VS Code. <br data-v-3412ef6c${_scopeId5}><br data-v-3412ef6c${_scopeId5}> Ako men\u0161\xED ved\u013Eaj\u0161\xED projekt spom\xEDnam aj str\xE1nku <a href="http://www.umy-ma.sk" target="_blank" rel="noopener noreferrer" data-v-3412ef6c${_scopeId5}>umy-ma.sk</a>, ktor\xFA som vytvoril ako jednoduch\xFA vizitku pre kamar\xE1tov pomocou Vite. Napriek minimalistick\xE9mu pr\xEDstupu projekt sp\u013A\u0148a po\u017Eiadavky na r\xFDchle a ekonomick\xE9 nasadenie. <br data-v-3412ef6c${_scopeId5}><br data-v-3412ef6c${_scopeId5}> Moj\xEDm cie\u013Eom je akt\xEDvne pracova\u0165 na zmyslupln\xFDch projektoch, ktor\xE9 mi umo\u017Enia \u010Falej rozv\xEDja\u0165 svoje schopnosti ako fullstack developer, pracova\u0165 s modern\xFDm frontendom, backendom, API architekt\xFArou a pr\xEDpadne aj integrova\u0165 IoT. </div>`);
                                  } else {
                                    return [
                                      createVNode("div", {
                                        class: "text-justify",
            ...
            _push2(`</section><section data-v-3412ef6c${_scopeId}>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VSheet, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<h2 class="text-h5 font-weight-medium mb-4" data-v-3412ef6c${_scopeId4}> Pou\u017Eit\xE9 technol\xF3gie na tomto projekte </h2><div class="d-flex justify-center flex-wrap my-4" data-v-3412ef6c${_scopeId4}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3412ef6c"]]);

export { index as default };
//# sourceMappingURL=index-B7_c5XGD.mjs.map
