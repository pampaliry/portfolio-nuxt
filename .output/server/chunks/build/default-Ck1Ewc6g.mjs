                                        ...
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VCol, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(VAppBarNavIcon, {
                                                  class: "d-sm-none",
                                                  "aria-label": "Zobrazi\u0165 naviga\u010Dn\xE9 menu",
                                                  onClick: ($event) => drawer.value = !drawer.value
                                                }, null, _parent8, _scopeId7));
                                                _push8(ssrRenderComponent(VToolbarTitle, { class: "d-none d-sm-flex ml-2" }, {
                                                ...
                                                return [
                                                  ...
                                                  createVNode(VToolbarTitle, { class: "d-none d-sm-flex ml-2" }, {
                                                    default: withCtx(() => [
                                                      createVNode(_component_LogoRotate, { "aria-hidden": "true" })
                                                    ]),
                                                    _: 1
                                          ...
                                          _push7(ssrRenderComponent(VSpacer, { class: "d-sm-none" }, null, _parent7, _scopeId6));
                                          _push7(ssrRenderComponent(VCol, { class: "d-flex justify-end align-center" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                ...
                                                _push8(`<!--]--></div>`);
                                                _push8(ssrRenderComponent(VToolbarTitle, { class: "d-sm-none d-flex justify-end" }, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(_component_LogoRotate, { "aria-hidden": "true" }, null, _parent9, _scopeId8));
                                                    } else {
                                                ...
                                                return [
                                                  ...
                                                  createVNode(VToolbarTitle, { class: "d-sm-none d-flex justify-end" }, {
                                                    default: withCtx(() => [
                                                      createVNode(_component_LogoRotate, { "aria-hidden": "true" })
                                                    ]),
                                                    _: 1
                                          ...
                                          return [
                                            ...
                                            createVNode(VSpacer, { class: "d-sm-none" }),
                                            createVNode(VCol, { class: "d-flex justify-end align-center" }, {
                                              default: withCtx(() => [
                                                createVNode("div", { class: "d-none d-sm-flex" }, [
                                                  (openBlock(), createBlock(Fragment, null, renderList(navLinks, (link) => {
                                                    return createVNode(VBtn, {
...
//# sourceMappingURL=default-Ck1Ewc6g.mjs.map
